...
The heatmaps do look pretty, but I don't think we can clearly see the pattern hypothesized before. The only striking effect is the change in GDP from 2008 to 2009. I'd assume that's the global financial crisis that left it's mark on the data.
